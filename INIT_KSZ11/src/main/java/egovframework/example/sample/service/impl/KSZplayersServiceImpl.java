...
@Service("KSZplayersService")
public class KSZplayersServiceImpl extends EgovAbstractServiceImpl implements KSZplayersService {

	private static final Logger LOGGER = LoggerFactory.getLogger(KSZplayersServiceImpl.class);

	/** SampleDAO */
	// TODO ibatis 사용
	@Resource(name = "KSZplayersDAO")
	private KSZplayersDAO KSZplayersDAO;
	// TODO mybatis 사용
	...
	public String insertKSZplayers(KSZplayersVO vo) throws Exception {
		...
		KSZplayersDAO.insertKSZplayers(vo);
		return id;
	}
	...
	public void updateKSZplayers(KSZplayersVO vo) throws Exception {
		KSZplayersDAO.updateKSZplayers(vo);
	}
	...
	public void deleteKSZplayers(KSZplayersVO vo) throws Exception {
		KSZplayersDAO.deleteKSZplayers(vo);
	}
	...
	public KSZplayersVO selectKSZplayers(KSZplayersVO vo) throws Exception {
		KSZplayersVO playersresultVO = KSZplayersDAO.selectKSZplayers(vo);
		if (playersresultVO == null)
			throw processException("info.nodata.msg");
		return playersresultVO;
	}
	...
	public List<?> selectKSZplayersList(KSZplayersDefaultVO playerssearchVO) throws Exception {
		return KSZplayersDAO.selectKSZplayersList(playerssearchVO);
	}
	...
	public int selectKSZplayersListTotCnt(KSZplayersDefaultVO playerssearchVO) {
		return KSZplayersDAO.selectKSZplayersListTotCnt(playerssearchVO);
	}
